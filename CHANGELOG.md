...
- *(deps)* bump the all-dependencies group with 12 updates ([#162](https://github.com/joshka/ja/pull/162))
- *(deps)* bump actions/checkout from 6 to 7 ([#163](https://github.com/joshka/ja/pull/163))
- *(deps)* bump rand from 0.8.5 to 0.8.6 ([#160](https://github.com/joshka/ja/pull/160))
- *(deps)* bump tar from 0.4.45 to 0.4.46 ([#161](https://github.com/joshka/ja/pull/161))
...
- *(deps)* bump the all-dependencies group across 1 directory with 6 updates ([#134](https://github.com/joshka/ja/pull/134))
- *(deps)* bump clap in the all-dependencies group ([#131](https://github.com/joshka/ja/pull/131))
- *(deps)* bump the all-dependencies group across 1 directory with 4 updates ([#129](https://github.com/joshka/ja/pull/129))
...
- *(deps)* bump the all-dependencies group across 1 directory with 4 updates (#110)
- *(deps)* bump the all-dependencies group with 2 updates (#108)
- *(deps)* bump the all-dependencies group with 2 updates (#106)

## [0.1.28](https://github.com/joshka/ja/compare/ja-v0.1.27...ja-v0.1.28) - 2024-12-16
...
- *(deps)* bump the all-dependencies group with 4 updates ([#99](https://github.com/joshka/ja/pull/99))
- *(deps)* bump the all-dependencies group across 1 directory with 3 updates ([#97](https://github.com/joshka/ja/pull/97))

## [0.1.25](https://github.com/joshka/ja/compare/ja-v0.1.24...ja-v0.1.25) - 2024-10-22

### Other

- *(deps)* bump the all-dependencies group across 1 directory with 4 updates ([#94](https://github.com/joshka/ja/pull/94))
- *(deps)* bump the all-dependencies group across 1 directory with 3 updates ([#92](https://github.com/joshka/ja/pull/92))
- *(deps)* bump the all-dependencies group across 1 directory with 2 updates ([#90](https://github.com/joshka/ja/pull/90))
- *(deps)* bump the all-dependencies group with 4 updates ([#87](https://github.com/joshka/ja/pull/87))

## [0.1.24](https://github.com/joshka/ja/compare/ja-v0.1.23...ja-v0.1.24) - 2024-09-02

### Other
- *(deps)* bump the all-dependencies group across 1 directory with 5 updates ([#85](https://github.com/joshka/ja/pull/85))

## [0.1.23](https://github.com/joshka/ja/compare/ja-v0.1.22...ja-v0.1.23) - 2024-08-20

### Other
- *(deps)* bump the all-dependencies group with 4 updates ([#83](https://github.com/joshka/ja/pull/83))
- *(deps)* bump the all-dependencies group with 3 updates ([#81](https://github.com/joshka/ja/pull/81))

## [0.1.22](https://github.com/joshka/ja/compare/ja-v0.1.21...ja-v0.1.22) - 2024-08-06

### Other
- *(deps)* bump the all-dependencies group with 2 updates ([#79](https://github.com/joshka/ja/pull/79))

## [0.1.21](https://github.com/joshka/ja/compare/ja-v0.1.20...ja-v0.1.21) - 2024-08-02

### Other
- *(deps)* bump the all-dependencies group with 3 updates ([#77](https://github.com/joshka/ja/pull/77))
...
### Other
- *(deps)* bump the all-dependencies group with 2 updates ([#73](https://github.com/joshka/ja/pull/73))
...
### Other
- *(deps)* bump the all-dependencies group with 2 updates ([#69](https://github.com/joshka/ja/pull/69))
...
### Other
- *(deps)* bump the all-dependencies group with 3 updates ([#64](https://github.com/joshka/ja/pull/64))
...
### Other
- *(deps)* bump strum_macros from 0.26.1 to 0.26.2 ([#39](https://github.com/joshka/ja/pull/39))
- *(deps)* bump async-openai from 0.19.1 to 0.20.0 ([#40](https://github.com/joshka/ja/pull/40))
- *(deps)* bump tokio from 1.36.0 to 1.37.0 ([#41](https://github.com/joshka/ja/pull/41))
- *(deps)* bump serde_json from 1.0.114 to 1.0.115 ([#42](https://github.com/joshka/ja/pull/42))
- *(deps)* bump clap from 4.5.2 to 4.5.4 ([#43](https://github.com/joshka/ja/pull/43))
