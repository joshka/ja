...
## [0.1.27](https://github.com/joshka/ja/compare/ja-v0.1.26...ja-v0.1.27) - 2024-12-04

### Other

- *(deps)* bump anstream from 0.6.7 to 0.6.15 in the cargo group ([#102](https://github.com/joshka/ja/pull/102))
- *(deps)* bump the all-dependencies group with 3 updates ([#100](https://github.com/joshka/ja/pull/100))
